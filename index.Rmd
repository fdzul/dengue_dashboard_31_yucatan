---
title: "Programa de Prevención y Control del Dengue de Yucatán 2023"
output: 
...
if(as.vector(Sys.info()["sysname"]) == "Darwin"){
  ...
  source("~/Library/CloudStorage/Dropbox/r_developments/r_new_functions/3.Functions/boldenr/heatmap_dengue.R")
    ...
    source("~/Library/CloudStorage/Dropbox/r_developments/r_new_functions/3.Functions/cl_interactive_map.R")
...
boldenr::hot_blocks(loc = "Valladolid",
                    ...
                    blocks = x,
                    cve_mpo = "102",
                    sem1 = lubridate::epiweek(Sys.time())-2,
                    risk = TRUE)
