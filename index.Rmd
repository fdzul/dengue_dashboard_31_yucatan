...
```{r indicador_ovitrampas_by_ovitrap, echo=FALSE, error=TRUE, message=FALSE,dpi=300, warning=FALSE, fig.align = "center", out.width="90%", fig.show = "hold"}
...
```{r indicador_ovitrampas_by_blocks, echo=FALSE, error=TRUE, message=FALSE,dpi=300, warning=FALSE, fig.align = "center", out.width="90%", fig.show = "hold"}
ovitraps_occupancy_abundancy(ovitraps_path = path_vect,
                             scale = "blocks")
```
