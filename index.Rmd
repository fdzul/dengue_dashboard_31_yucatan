...
#### [ **Manzanas Calientes de Valladolid en la semana `r lubridate::epiweek(Sys.Date())`**]{style="color:#7d9029"}
...
#### [ **Predicción del Número de Huevos en el área urbana de Valladolid en la semana `r lubridate::epiweek(Sys.Date())`**]{style="color:#7d9029"}
