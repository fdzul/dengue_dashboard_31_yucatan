...
#### [**Avances de Control Larvario en el área urbana de Mérida**]{style="color:#7d9029"}
...
### [**Mapas de Control Larvario**]{style="color:#660033"}
...
:::{style="display: grid; width: 1px; grid-template-columns: 700px 700px; align-items: start; justify-content: space-between;"}
#### [**Área Metropolitana de Mérida**]{style="color:#660033"}

```{r cl_map_merida_barrido, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "cl_map_merida_barr.html",
                       width = "100%", 
                       height = "700vh")
```
...
```{r cl_map_merida_focalizado, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "cl_map_merida_foc.html",
                       width = "100%", 
                       height = "700vh")
```
:::
