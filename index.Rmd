...
#### [**Manzanas Calientes del Área Urbana de Mérida en la Semana `r lubridate::epiweek(Sys.Date())-1`**]{style="color:#7d9029"}
...
#### [**Predicción del Número de Huevos en el área Urbana de Mérida en la semana `r lubridate::epiweek(Sys.Date())-1`**]{style="color:#7d9029"}
...
#### [**Indicador de Ovitrampas en Piste**]{style="color:#7d9029"}
...
#### [**Predicción del Número de Huevos en el área urbana de Piste en la semana `r lubridate::epiweek(Sys.Date())-1`**]{style="color:#7d9029"}
...
#### [**Manzanas Calientes de Ticul en la semana `r lubridate::epiweek(Sys.Date())-1`**]{style="color:#7d9029"}
...
#### [**Predicción del Número de Huevos en el área urbana de Ticul en la semana `r lubridate::epiweek(Sys.Date())-1`**]{style="color:#7d9029"}
...
#### [**Manzanas Calientes de Peto en la semana `r lubridate::epiweek(Sys.Date())-1`**]{style="color:#7d9029"}
...
#### [**Predicción del Número de Huevos en el área urbana de Peto en la semana `r lubridate::epiweek(Sys.Date())-1`**]{style="color:#7d9029"}
...
#### [**Manzanas Calientes de Tekax en la semana `r lubridate::epiweek(Sys.Date())-1`**]{style="color:#7d9029"}
...
#### [**Predicción del Número de Huevos en el área urbana de Tekax en la semana `r lubridate::epiweek(Sys.Date())-1`**]{style="color:#7d9029"}
...
#### [**Manzanas Calientes de Oxkutzcab en la semana `r lubridate::epiweek(Sys.Date())-1`**]{style="color:#7d9029"}
...
#### [**Predicción del Número de Huevos en el área urbana de Oxkutzcab en la semana `r lubridate::epiweek(Sys.Date())-1`**]{style="color:#7d9029"}
...
### [**Control Larvario**]{style="color:#660033"}
...
#### [**Avances de Control Larvario por Municipio de la Jurisdición 01 Mérida**]{style="color:#7d9029"}
...
#### [**Avances de Control Larvario por Municipio de la Jurisdición 02 Valladolid**]{style="color:#7d9029"}
...
#### [**Avances de Control Larvario por Municipio de la Jurisdición 03 Ticul**]{style="color:#7d9029"}
...
### [**Mapa de Control Larvario**]{style="color:#660033"}
...
::: grid-container
::: grid-item
#### [**Acumulado**]{style="color:#660033;font-size:100%"}

```{r cl_map_merida_barrido_cum, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_merida_barr_cum.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
::: grid-item
#### [**Últimos Dos Meses**]{style="color:#660033;font-size:100%"}

```{r cl_map_merida_barrido_two_month, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_merida_barr_two_month.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
::: grid-item
#### [**Último Més**]{style="color:#660033;font-size:100%"}

```{r cl_map_merida_barrido_month, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_merida_barr_month.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
::: grid-item
#### [**Últimas dos Semanas**]{style="color:#660033;font-size:100%"}
:::

::: grid-item
```{r cl_map_merida_foc_cum, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_merida_foc_cum.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
::: grid-item
```{r cl_map_merida_foc_two_month, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_merida_foc_two_month.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
::: grid-item
```{r cl_map_merida_foc_month, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_merida_foc_month.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
<p>Las acciones de prevención y control son actualizados los miercoles</p>
<hr style="height:2px;border-width:0;color:#330019;background-color:#330019">
...
```{r cl_map_peto_foc_cum, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_peto_foc_cum.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
```{r cl_map_peto_foc_two_month, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_peto_foc_two_month.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
```{r cl_map_peto_foc_month, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_peto_foc_month.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
::: grid-item
#### [**Últimas dos Semanas**]{style="color:#660033;font-size:100%"}
```{r cl_map_peto_foc_two_week, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_peto_foc_two_week.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
```{r cl_map_oxkutzcab_barr_cum, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_oxkutzcab_barr_cum.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
```{r cl_map_oxkutzcab_barr_two_month, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_oxkutzcab_barr_two_month.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
```{r cl_map_oxkutzcab_barr_month, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_oxkutzcab_barr_month.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
::: grid-item
#### [**Últimas dos Semanas**]{style="color:#660033;font-size:100%"}
```{r cl_map_oxkutzcab_barr_two_week, warning=FALSE, message=FALSE}
htmltools::tags$iframe(src = "/Users/fdzul/Library/CloudStorage/Dropbox/r_developments/r_new_functions/cl_map_oxkutzcab_barr_two_week.html",
                       width = "100%", 
                       height = "700vh")
```
:::
...
### [**Nebulización en Frío (ULV)**]{style="color:#660033"}
...
#### [**Avances de Nebulizacion en Frío (UBV) por Jurisdición Sanitaria**]{style="color:#7d9029"}
...
#### [**Avances de Nebulizacion en Frío (UBV)por Municipio de la Jurisdición 01 Mérida**]{style="color:#7d9029"}
...
#### [**Avances de Nebulizacion en Frío (UBV) por Municipio de la Jurisdición 02 Valladolid**]{style="color:#7d9029"}
...
#### [**Avances de Nebulizacion en Frío (UBV) por Municipio de la Jurisdición 03 Ticul**]{style="color:#7d9029"}
...
### [**Termonebulización**]{style="color:#660033"}
...
#### [**Termonubulización por Jurisdición Sanitaria**]{style="color:#7d9029"}
...
#### [**Termonebulización Municipio de la Jurisdición 01 Mérida**]{style="color:#7d9029"}
...
#### [**Termonebulización por Municipio de la Jurisdición 02 Valladolid**]{style="color:#7d9029"}
...
#### [**Termonebulización por Municipio de la Jurisdición 03 Ticul**]{style="color:#7d9029"}
...
### [**Control de Probables**]{style="color:#660033"}
...
<h1>Jurisdicción Sanitaria 01 Mérida</h1>
...
::: grid-item
#### [**2022**]{style="color:#660033;font-size:100%"}
```{r cp_merida_2022}
# Step 1. define the path ####
path <- "/Users/fdzul/Library/CloudStorage/OneDrive-Personal/datasets/CENAPRECE/2022/31_yucatan/"
...
::: grid-item
#### [**2023**]{style="color:#660033;font-size:100%"}
```{r cp_merida_2023}
# Step 1. define the path ####
...
<h1>Jurisdicción Sanitaria 02 Valladolid</h1>
...
<h1>Jurisdicción Sanitaria 03 Ticul</h1>
...
### [**Mérida (Probables)**]{style="color:#7d9029"}

```{r cadenas_merida_probable}
...
### [**Mérida (Confirmados)**]{style="color:#7d9029"}

```{r cadenas_merida_confirmados}
denhotspots::transmission_chains_map(geocoded_dataset = z,
                                     cve_edo = "31",
                                     locality = "Merida",
...
### [**Valladolid (Probables)**]{style="color:#7d9029"}

```{r cadenas_valladolid_probable}
denhotspots::transmission_chains_map(geocoded_dataset = z,
                                     cve_edo = "31",
                                     locality = "Valladolid",
                                     dengue_cases = "Probable")
...
### [**Valladolid (Confirmados)**]{style="color:#7d9029"}

```{r cadenas_valladolid_confirmados}
denhotspots::transmission_chains_map(geocoded_dataset = z,
                                     cve_edo = "31",
                                     locality = "Valladolid",
                                     dengue_cases = "Confirmado")
...
### [**Tekax (Probables)**]{style="color:#7d9029"}

```{r cadenas_tekax_confirmados}
denhotspots::transmission_chains_map(geocoded_dataset = z,
                                     cve_edo = "31",
...
library(sf)
# Step 2. run the spde model ####
x <- deneggs::eggs_hotspots_week(cve_mpo = "096",
                                           cve_edo = "31",
                                           year = "2023",
                                           hist_dataset = FALSE,
                                           locality = "Tizimin",
...
### [**Piste**]{style="color:#7d9029"}

```{r vector_hotspots_piste}
# step 1. define the path for the historic dataset ####
path_vect <- "/Users/fdzul/Library/CloudStorage/OneDrive-Personal/datasets/CENAPRECE/2023/31_yucatan"
path_coord <- paste(path_vect, "DescargaOvitrampasMesFco.txt", sep = "/")
...
library(sf)
# Step 2. run the spde model ####
x <- deneggs::eggs_hotspots_week(cve_mpo = "091",
                                           cve_edo = "31",
                                           year = "2023",
                                           hist_dataset = FALSE,
                                           locality = "Piste",
...
library(sf)
# Step 2. run the spde model ####
x <- deneggs::eggs_hotspots_week(cve_mpo = "089",
                                           cve_edo = "31",
                                           year = "2023",
                                           hist_dataset = FALSE,
                                           locality = "Ticul",
...
library(sf)
# Step 2. run the spde model ####
x <- deneggs::eggs_hotspots_week(cve_mpo = "058",
                                           cve_edo = "31",
                                           year = "2023",
                                           hist_dataset = FALSE,
                                           locality = "Peto",
...
library(sf)
# Step 2. run the spde model ####
x <- deneggs::eggs_hotspots_week(cve_mpo = "079",
                                           cve_edo = "31",
                                           year = "2023",
                                           hist_dataset = FALSE,
                                           locality = "Tekax de Alvaro Obregon",
...
### [**Oxkutzcab**]{style="color:#7d9029"}

```{r vector_hotspots_oxkutzcab}
# step 1. define the path for the historic dataset ####
path_vect <- "/Users/fdzul/Library/CloudStorage/OneDrive-Personal/datasets/CENAPRECE/2023/31_yucatan"
path_coord <- paste(path_vect, "DescargaOvitrampasMesFco.txt", sep = "/")
...
library(sf)
# Step 2. run the spde model ####
x <- deneggs::eggs_hotspots_week(cve_mpo = "056",
                                           cve_edo = "31",
                                           year = "2023",
                                           hist_dataset = FALSE,
                                           locality = "Oxkutzcab",
